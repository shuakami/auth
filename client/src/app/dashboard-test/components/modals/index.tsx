...
export function EditNameModal({ isOpen, value, onChange, onClose, onSubmit }: EditNameModalProps) {
  const { t } = useI18n();
  return (
    <FormModal isOpen={isOpen} onClose={onClose} onSubmit={onSubmit} title={t.modals.editName} cancelText={t.common.cancel} submitText={t.common.save}>
      <Input
...
export function UpdateEmailModal({ isOpen, value, onChange, onClose, onSubmit }: UpdateEmailModalProps) {
  const { t } = useI18n();
  return (
    <FormModal isOpen={isOpen} onClose={onClose} onSubmit={onSubmit} title={t.modals.updateEmail} cancelText={t.common.cancel} submitText={t.account.updateEmail}>
