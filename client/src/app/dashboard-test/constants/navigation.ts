...
export const navItems: NavItem[] = [
  { id: 'account', label: 'Account', icon: User, href: '/dashboard-test' },
  { id: 'security', label: 'Security', icon: Lock, href: '/dashboard-test/security' },
  { id: 'sessions', label: 'Sessions', icon: Globe, href: '/dashboard-test/sessions' },
  { id: 'user', label: 'User', icon: User, href: '/dashboard-test/user' },
  { id: 'oauth', label: 'OAuth', icon: KeySquare, href: '/dashboard-test/oauth' },
];
