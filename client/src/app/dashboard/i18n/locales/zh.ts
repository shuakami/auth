...
export const zh = {
  ...
  security: {
    ...
    // 管理界面
    authenticatorAppEnabled: '验证器应用已启用',
    authenticatorAppEnabledDesc: '您的账户已通过验证器应用进行保护',
    status: '状态',
    enabled: '已启用',
    remainingBackupCodes: '剩余备份码',
    codesUnit: '个',
    disableAuthenticator: '禁用验证器应用',
    disableAuthenticatorDesc: '请输入验证器应用中的验证码或备份码以确认禁用。',
    totpCodePlaceholder: '6 位验证码',
    backupCodePlaceholder: '备份码',
    useBackupCode: '使用备份码',
    useTotpCode: '使用验证码',
    confirmDisable: '确认禁用',
    authenticatorDisabled: '验证器应用已禁用',
    disableFailed: '禁用失败',
    verifyPassword: '验证密码',
    verifyPasswordDesc: '请输入您的账户密码以继续设置验证器应用。',
    passwordVerifyFailed: '密码验证失败',
    codeVerifyFailed: '验证码错误',
    manualEntryHint: '或手动输入密钥：',
