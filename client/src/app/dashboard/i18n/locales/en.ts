...
export const en: Locale = {
  ...
  security: {
    ...
    authenticatorAppEnabledDesc: 'Your account is protected with an authenticator app',
    status: 'Status',
    enabled: 'Enabled',
    remainingBackupCodes: 'Remaining backup codes',
    codesUnit: '',
    disableAuthenticator: 'Disable authenticator app',
    disableAuthenticatorDesc: 'Enter the code from your authenticator app or a backup code to confirm.',
    totpCodePlaceholder: '6-digit code',
    backupCodePlaceholder: 'Backup code',
    useBackupCode: 'Use backup code',
    useTotpCode: 'Use authenticator code',
    confirmDisable: 'Confirm disable',
    authenticatorDisabled: 'Authenticator app disabled',
    disableFailed: 'Failed to disable',
    verifyPassword: 'Verify password',
    verifyPasswordDesc: 'Enter your account password to continue setting up the authenticator app.',
    passwordVerifyFailed: 'Password verification failed',
    codeVerifyFailed: 'Invalid code',
    manualEntryHint: 'Or enter the key manually:',
  ...
  oauth: {
    ...
    scopes: {
      ...
      groups: 'Groups',
      groupsDesc: 'User roles and permission groups',
      security_read: 'Read security status',
      security_readDesc: 'Read 2FA and passkey status',
      security_write: 'Manage security settings',
      security_writeDesc: 'Manage 2FA, backup codes, and passkeys',
  ...
  integrationGuide: {
    ...
    params: {
      ...
      scope: 'Space-separated scopes (e.g., openid profile email groups security.read)',
