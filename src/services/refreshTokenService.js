 ...
 */
export async function createRefreshToken(userId, deviceInfo, clientId = null, parentId = null, expiresIn = 60 * 60 * 24 * 15, scope = null) {
  return tokenController.createRefreshToken(userId, deviceInfo, clientId, parentId, expiresIn, scope);
}
